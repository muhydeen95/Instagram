...
export class DocumentStatusComponent implements OnInit {
  ...
  public userChats = [
    ...
    {id: 4, user: 'recipient',  message: 'that tell a computer how an be done using a variety of computer programming languages, such as JavaScript, Python, and C++.,', time: '2:12pm'},
    {id: 5, user: 'sender',  message: 'that tell a computer how an be done using a variety of computer programming languages, such as JavaScript, Python, and C++.,', time: '2:35pm'},
    {id: 6, user: 'recipient',  message: 'that tell a computer how an be done using a variety of computer programming languages, such as JavaScript, Python, and C++.,', time: '2:35pm'},
